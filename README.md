...
**Nagłówek i dni.** Na górze jest przełącznik tygodnia (strzałki i zakres dat; kliknięcie w daty otwiera kalendarz), nazwa ekipy i przycisk „Przekaż plan”. Pod nim pięć kafelków dni: kolorowy pasek dnia, liczba przystanków i łączny czas jazdy, ikona księżyca przy dniu z noclegiem, ptaszek i „gotowe”, gdy wszystko wykonano.

**Pasek dnia** jest przypięty u góry ekranu także podczas przewijania listy. Symbolami pokazuje liczbę przystanków, łączny czas w drodze, dystans, powrót do bazy (wyróżniony, gdy trwa godzinę lub dłużej) i ile wykonano. Obok są: przeliczenie odległości (żółte, gdy trzeba je policzyć), **Prowadź całą trasę w Google Maps** (pozostałe, niewykonane przystanki po kolei, od miejsca, w którym jest telefon; Google przyjmuje do 9 punktów pośrednich, w przeglądarce na telefonie tylko 3 — aplikacja Google Maps obsługuje 9), wyczyszczenie dnia i **Optymalizuj**, które układa już dodane przystanki w najkrótszą kolejność (od 2 przystanków).

**Trasa jako oś czasu.** Start z bazy (albo z noclegu dnia poprzedniego) → czas dojazdu → przystanek → … → „Następny przystanek” → czas powrotu → powrót do bazy albo nocleg. Przystanek to jeden zwarty wiersz: numer w kolorze dnia (ptaszek, gdy wykonany), nazwa i adres, drobne znaczniki (rodzaj pracy, liczba zadań, notatka, ostrzeżenia) oraz okrągła strzałka nawigacji do tego jednego punktu. Stuknięcie w nazwę albo w „⋯” rozwija akcje: Szczegóły, Miejsce pracy, Notatka, Inny dzień, wyżej/niżej i usunięcie z dnia. Na komputerze kolejność zmienisz też przeciąganiem.
