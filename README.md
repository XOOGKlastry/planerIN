...
Nie ma automatycznego układania całego tygodnia ani szacowania czasu pracy — to Ty decydujesz o kolejności i podziale na dni, w całości ręcznie. Tydzień obejmuje pięć dni roboczych (Pon–Pt); soboty i niedzieli nie ma wśród kafelków dni. Dla wybranego dnia aplikacja pokazuje pozostałe zlecenia posortowane według czasu dojazdu od ostatnio dodanego przystanku (lub od bazy / miejsca noclegu, jeśli dzień jest jeszcze pusty) — najbliższy jest oznaczony „Najbliżej”. Wybierasz, klikając „Dodaj” na liście. Widać od razu tylko pięć najbliższych propozycji — przy większej puli reszta chowa się pod „Pokaż więcej”, żeby lista nie rozwijała się na cały ekran.
...
**Ostrzeżenie o bliskich punktach** — gdy dwa punkty w tygodniowej puli dzieli mniej niż 20 minut jazdy, oba dostają wyraźny czerwony znacznik z czasem i nazwą tego drugiego punktu (na liście dnia i na liście podpowiedzi). To zwykle sygnał, że warto je odwiedzić jednego dnia po kolei, albo że to w istocie ten sam adres wpisany dwa razy. Znacznik pojawia się dopiero po policzeniu odległości (przycisk „Policz odległości”) — bez tego aplikacja nie ma czasów dojazdu między punktami.
